...
const global = {
    ...
    api: {
        apiKey: '43734d602f9751c3dbebfd69f57d1456',
        apiUrl: 'https://api.themoviedb.org/3/'
    }
};
// Disply 20 Most populer movie
async function displayPopularMovies(){
    ...
    <div class="card-body">
      ...
      document.querySelector('#populer-movies').appendChild(div);  
    })
}
...
async function displayPopularShow(){
    ...
    <div class="card-body">
      ...
      document.querySelector('#populer-shows').appendChild(div);  
    })
}

// Disply 20 SEARCH populer movie
async function displaySearchMovies(){
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            <small class="text-muted">Release: ${search.release_date}</small>
        </p>
    </div>

        `;

      document.querySelector('#search-movies').appendChild(div);  
    })
}
...
<div class="details-bottom">
    ...
    <ul>
        ...
        <li><span class="text-secondary">Runtime: </span>${movie.runtime} miutes</li>
...
<div class="details-bottom">
    ...
    <ul>
        ...
        <li><span class="text-secondary">Last Episodes To Air: </span>${show.first_air_date}</li>
...
async function search(){
    ...
    global.search.type = urlParms.get('type');
    global.search.term = urlParms.get('search-term');
